...
- Follow this Atlas tutorial to create an Atlas account, Deploy a Free Tier Cluster & connecting to it, inserting & querying data: <strong>https://docs.atlas.mongodb.com/getting-started/</strong> <br>
